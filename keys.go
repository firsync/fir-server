...
func initKeys() *ED25519Keys {
	keyFolderPath := filepath.Join(os.Getenv("HOME"), ".fir", "keys")
	keyFolderExists, keyFolderExistsErr := folderExists(keyFolderPath)
	if keyFolderExistsErr != nil {
		log.Println("keyFolderExistsErr: ", keyFolderExistsErr)
	}
	if !keyFolderExists {
